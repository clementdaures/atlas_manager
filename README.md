# ATLAS MANAGER - ANDHAKARA

**Pipeline repository for the animated short film _Andhakara_**
...
- Interface hooks for Maya and Houdini pipelines
...
- Support for both DCCs (Maya & Houdini)
