...
from atlas_manager.core.constants import ValidationState
from atlas_manager.ui.Qt import QtWidgets, QtCore, QtGui
from atlas_manager.ui.widgets import path_browser
from atlas_manager.ui.widgets.common import AtlasButton, AtlasButtonBox
from atlas_manager.ui.dialog.feedback import Feedback
from atlas_manager.ui.widgets.value_widgets import DropList
from atlas_manager.ui.dialog.subproject_dialog import EditSubprojectDialog
...
class SetProjectDialog(QtWidgets.QDialog):
    ...
    def build_ui(self):
        ...
        recent_pb = AtlasButton(text="Recent")
    ...
    def define_primary_ui(self):
        ...
        _primary_ui = {
            "project_root": {
                ...
                "value": os.path.dirname(self.atlas_project.absolute_path),
