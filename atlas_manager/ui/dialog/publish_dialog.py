...
atlas = atlas_manager.initialize("Maya")

from atlas_manager.dcc.maya.main import Dcc as maya_dcc
parent = maya_dcc().get_main_window()
# reload(atlas_manager)
from atlas_manager.objects import publisher
reload(publisher)
from atlas_manager.ui.dialog import publish_dialog
reload(publish_dialog)
from atlas_manager.ui import pick
_style_file = pick.style_file()

dialog = publish_dialog.PublishSceneDialog(atlas.project, styleSheet=str(_style_file.readAll(), "utf-8"), parent=parent)
dialog.show()
...
from atlas_manager.objects.preview import PreviewContext
...
from atlas_manager.ui import pick
from atlas_manager.ui.widgets.value_widgets import Vector2Int
from atlas_manager.ui.widgets.pop import WaitDialog

from atlas_manager.plugins.trolling import ee_publish as ee_pbh #MODIFIED FOR THE JOKE
...
class PublishSceneDialog(QtWidgets.QDialog):
    ...
    def _build_header(self):
        ...
        path_header = AtlasLabel(text="Path: ")
        path_layout.addWidget(path_header)
        name_header = AtlasLabel(text="Name: ")
    ...
    def _build_validations(self):
        ...
        separator.setStyleSheet("background-color: rgb(122, 83, 207);")
    ...
    def publish(self):
        ...
        if warnings:
            ...
            ee_pbh.show_gif_window() #MODIFIED FOR THE JOKE
            self.close()
            self.deleteLater()
            return
...
class ValidateRow(QtWidgets.QHBoxLayout):
    ...
    def build_widgets(self):
        ...
        # button
        self.button = AtlasButton(text=self.name)
        ...
        # maintenance icons
        self.info_pb = AtlasIconButton(icon_name="info.png")
        self.info_pb.set_size(26)
        self.select_pb = AtlasIconButton(icon_name="select.png")
        self.select_pb.set_size(26)
        self.fix_pb = AtlasIconButton(icon_name="fix.png")
...
class ExtractRow(QtWidgets.QHBoxLayout):
    ...
    def build_widgets(self):
        ...
        # maintenance icons
        self.info = AtlasIconButton(icon_name=self.extract.name, circle=True)
