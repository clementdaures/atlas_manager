...
from atlas_manager.ui.widgets.common import AtlasMessageBox, AtlasButtonBox
...
class Feedback:
    ...
    def pop_info(
        ...
        msg = AtlasMessageBox(parent=self.parent)
        if not self.parent:
    ...
    def pop_question(
        ...
        q = AtlasMessageBox(parent=self.parent)
        if not self.parent:
            _style_file = pick.style_file(file_name="atlasManager.qss")
...
class Confirmation(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None, confirmation_word=None):
        ...
        button_box = AtlasButtonBox(QtWidgets.QDialogButtonBox.Ok | QtWidgets.QDialogButtonBox.Cancel)
