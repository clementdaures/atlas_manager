...
class UpdateDialog(QtWidgets.QDialog):
    ...
    def __init__(self, release_object, parent=None):
        ...
        self.setWindowTitle("Atlas Manager Update")
    ...
    def build_header(self):
        ...
        header_label = QtWidgets.QLabel("New Release Available") if self.release_object.is_newer else QtWidgets.QLabel("Atlas Manager is up to date")
    ...
    def build_ui(self):
        ...
        if self.release_object.is_newer:
            ...
            header_label = QtWidgets.QLabel("Atlas Manager is up to date")
            header_label.setAlignment(QtCore.Qt.AlignCenter)
            header_label.setFont(QtGui.QFont("Arial", 16))
            self.layouts.header_layout.addWidget(header_label)

            info_label = QtWidgets.QLabel("You are using the latest version of Atlas Manager. "
                                          "Previous versions can be found on the releases page.")
            self.layouts.body_layout.addWidget(info_label)
            releases_url = "https://github.com/masqu3rad3/atlas_manager/releases"
