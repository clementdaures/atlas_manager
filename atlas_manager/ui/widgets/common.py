...
class AtlasButton(QtWidgets.QPushButton, StyleEditor):
...
class AtlasIconButton(AtlasButton):
...
class AtlasButtonBox(QtWidgets.QDialogButtonBox):
    """Unified button box class for the whole app."""

    def __init__(self, *args, font_size=10, **kwargs):
        super(AtlasButtonBox, self).__init__(*args, **kwargs)
    ...
    def event(self, event):
        ...
        return super(AtlasButtonBox, self).event(event)
...
class AtlasMessageBox(QtWidgets.QMessageBox):
    def __init__(self, *args, font_size=10, **kwargs):
        super(AtlasMessageBox, self).__init__(*args, **kwargs)
        self.set_font_size(font_size)
...
class AtlasLabelButton(AtlasButton):
    ...
    def __init__(self, *args, color=(255, 255, 255), **kwargs):
        super(AtlasLabelButton, self).__init__(*args, **kwargs)
