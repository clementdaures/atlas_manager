...
from atlas_manager.core.constants import DataTypes, ValidationState
from atlas_manager.ui.Qt import QtWidgets, QtCore, QtGui
from atlas_manager.ui.widgets import value_widgets
...
from atlas_manager.ui.dialog.user_dialog import NewUserDialog
...
class UsersDefinitions(QtWidgets.QWidget):
    ...
    def build_static_widgets(self):
        ...
        self.layouts.header_layout.addWidget(
            HorizontalSeparator(color=(122, 83, 207), height=1)
        )
        ...
        add_metadata_button = AtlasButton(text="Add New User", parent=self)
        add_remove_buttons_layout.addWidget(add_metadata_button)
        remove_metadata_button = AtlasButton(text="Delete User", parent=self)
    ...
    def _add_value_widget(self, name, data):
        ...
        reset_password_button = AtlasButton(text="Reset Password", parent=self)
...
class MetadataDefinitions(QtWidgets.QWidget):
    ...
    def build_static_widgets(self):
        ...
        add_remove_buttons_layout = QtWidgets.QHBoxLayout()
        self.layouts.left_layout.addLayout(add_remove_buttons_layout)
        add_metadata_button = AtlasButton(text="Add New Metadata", parent=self)
        add_remove_buttons_layout.addWidget(add_metadata_button)
        remove_metadata_button = AtlasButton(text="Delete Metadata", parent=self)
        add_remove_buttons_layout.addWidget(remove_metadata_button)
...
class CategoryDefinitions(QtWidgets.QWidget):
    ...
    def build_static_widgets(self):
        ...
        add_remove_buttons_layout = QtWidgets.QHBoxLayout()
        self.layouts.left_layout.addLayout(add_remove_buttons_layout)
        add_category_pb = AtlasButton(text="Add New Category", parent=self)
        add_remove_buttons_layout.addWidget(add_category_pb)
        delete_category_pb = AtlasButton(text="Delete Category", parent=self)
    ...
    def __add_extracts(self, form_layout, data):
        ...
        add_extract_button = AtlasIconButton(
            icon_name="plus", size=32, background_color="#405040", parent=self
        )
        extracts_buttons_layout.addWidget(add_extract_button)
        remove_extract_button = AtlasIconButton(
            icon_name="minus", size=32, parent=self, background_color="#504040"
        )
