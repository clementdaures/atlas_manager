...
from atlas_manager.ui.widgets.common import AtlasButton, AtlasIconButton
...
class PathBrowser(QtWidgets.QWidget):
    ...
    def __init__(self, name, object_name=None, value=None, disables=None, items=None, **kwargs):
        ...
        self.button = AtlasIconButton(icon_name="folder", circle=False)
        ...
        if items:
            ...
            self.items_button = AtlasIconButton(icon_name="menu", circle=False)
