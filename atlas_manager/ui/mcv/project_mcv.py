...
from atlas_manager.ui.widgets.common import AtlasButton
from atlas_manager.ui import pick

class AtlasProjectWidget(QtWidgets.QWidget):
    ...
    def __init__(self, main_object, parent=None):
        ...
        self.layout = AtlasProjectLayout(main_object, parent=self)
...
class AtlasProjectLayout(QtWidgets.QHBoxLayout):
    ...
    def __init__(self, main_object, parent=None):
        ...
        self.set_project_btn = AtlasButton()
        ...
        self.recent_projects_btn = AtlasButton()
