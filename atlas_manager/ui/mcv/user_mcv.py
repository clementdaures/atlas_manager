...
from atlas_manager.ui.dialog.user_dialog import LoginDialog
from atlas_manager.ui.widgets.common import AtlasButton, ResolvedText

class AtlasUserWidget(QtWidgets.QWidget):
    ...
    def __init__(self, user_obj, parent=None):
        ...
        self.layout = AtlasUserLayout(user_obj, parent=parent)
...
class AtlasUserLayout(QtWidgets.QHBoxLayout):
