...
from atlas_manager.core.constants import DataTypes
from atlas_manager.core.settings import Settings
from atlas_manager.core.utils import get_nice_name

from atlas_manager.ui.widgets import value_widgets
from atlas_manager.ui.widgets.category_list import CategoryList

import atlas_manager.ui.widgets.browser
import atlas_manager.ui.widgets.path_browser
...
class SettingsLayout(QtWidgets.QFormLayout):
    ...
    widget_dict = {
        ...
        DataTypes.PATHBROWSER.value: atlas_manager.ui.widgets.path_browser.PathBrowser,
        DataTypes.FILEBROWSER.value: atlas_manager.ui.widgets.path_browser.FileBrowser,
        DataTypes.SUBPROJECTBROWSER.value: atlas_manager.ui.widgets.browser.SubprojectBrowser,
