...
from atlas_manager.core import utils, cli
from atlas_manager.external.fileseq import filesequence as fileseq
...
class Preview:
    ...
    def register_data(self, preview_data):
        ...
        if self.database_obj.object_type == ObjectType.WORK:
            ...
            # Unlike the work objects version, this is a Atlas Settings class.
