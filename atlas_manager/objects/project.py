...
from atlas_manager.objects.publisher import Publisher, SnapshotPublisher
from atlas_manager.core import filelog
from atlas_manager.core.settings import Settings
from atlas_manager.objects.subproject import Subproject
from atlas_manager.objects.work import Work
...
class Project(Subproject):
    ...
    def __init__(self, path=None, name=None):
        ...
        self._name = name
        self.__mode = ""
        # This makes sure the project folder is atlas_manager ready
        if path:
            self._set(path)
    ...
    def _set(self, absolute_path, commons_id=None):
        ...
        _database_path_obj = _absolute_path_obj / "_atlas_database"
