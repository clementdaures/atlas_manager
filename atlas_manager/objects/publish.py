...
from atlas_manager.objects.version import PromotedVersion
from atlas_manager.core.constants import ObjectType, BranchingModes
from atlas_manager.objects.version import PublishVersion, LiveVersion
...
class Publish(LocalizeMixin):
    ...
    def __init__(self, work_object):
        ...
        _folder = Path(self.work_object.get_abs_database_path("pbh")) # , self.work_object.name
    ...
    def path(self):
        ...
        return Path(self.work_object.path, "pbh").as_posix()
    ...
    def get_publish_data_folder(self):
        ...
        return self.work_object.get_abs_database_path("pbh") # , self.work_object.name

    def get_publish_project_folder(self):
        """Return the publish scene folder."""
        return self.work_object.get_abs_project_path("pbh") # , self.work_object.name
