...
import atlas_manager.objects.task
from atlas_manager.core import filelog
from atlas_manager.objects.metadata import Metadata
from atlas_manager.objects.entity import Entity
from atlas_manager.objects.task import Task
...
class Subproject(Entity):
    ...
    def delete_task(self, task_name):
        ...
        """
        # first get the task
        task: atlas_manager.objects.task.Task = self._tasks.get(task_name)
        if not task:
