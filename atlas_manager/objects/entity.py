"""Core module for Atlas Manager Objects."""
...
from atlas_manager.external import pyperclip
...
class Entity:
    """Base class for all Atlas Manager entities."""
    ...
    def get_purgatory_database_path(self, *args):
        ...
        Args:
            args (str): The path arguments.
                Any values passed here will be appended to the path.
        """
        return Path(self.guard.project_root, ".purgatory", "_atlas_database",  self.path, *args).as_posix()
