"""User module for Atlas Manager."""

import hashlib
from pathlib import Path
from atlas_manager.core.constants import ObjectType, ValidationState, ValidationResult
...
from atlas_manager.objects.commons import Commons
from atlas_manager.objects.guard import Guard

LOG = filelog.Filelog(logname=__name__, filename="atlas_manager")

try:
    from atlas_manager.ui.dialog import feedback
    FEED = feedback.Feedback()
except Exception as exc: # pylint: disable=broad-except
    from atlas_manager.core import cli
...
class User:
    ...
    def _validate_user_data(self):
        ...
        _user_dir = Path(_user_root, "AtlasManager")
