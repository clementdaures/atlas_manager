...
from atlas_manager.management.ui.mcv import ProjectPickWidget
...
class CreateFromManagementDialog(QtWidgets.QDialog):
    ...
    def __init__(self, management_handler, parent=None):
        ...
        self.atlas = management_handler.atlas_main
    ...
    def build_ui(self):
        ...
        _value = Path(self.atlas.project.absolute_path).parent.as_posix()
    ...
    def execute(self):
        ...
        if project_id:
            ...
            if not ret:
                msg, _msg_type = self.atlas.log.get_last_message()
