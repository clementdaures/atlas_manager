...
# from atlas_manager.ui import Qt
from atlas_manager.ui.widgets.pop import WaitDialog
from atlas_manager.ui.widgets.common import AtlasIconButton
...
class WidgetDataContainer:
    ...
    def __init__(self):
        ...
        self.list_view_button: QtWidgets.QPushButton = AtlasIconButton(icon_name="view-list", circle=False)
        self.icon_view_button: QtWidgets.QPushButton = AtlasIconButton(icon_name="view-icon", circle=False)
        self.__post_init__()
...
class ProjectPickWidget(QtWidgets.QWidget):
    ...
    def __init__(self, management_handler, parent=None):
        super().__init__()
        # self.atlas_main = management_handler.atlas_main
