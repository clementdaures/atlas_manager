...
from atlas_manager.ui.dialog.project_dialog import SetProjectDialog
from atlas_manager.ui.dialog.subproject_dialog import SelectSubprojectDialog
...
class Callbacks:
    ...
    def __init__(self):
        ...
        self.atlas_m = atlas_manager.initialize("houdini")
    ...
    def set_project(self, kwargs):
        ...
        """
        dialog = SetProjectDialog(self.atlas_m)
        ret = dialog.exec_()
    ...
    def set_subproject(self, kwargs):
        ...
        Args:
            kwargs (dict): The keyword arguments.
        """
        subproject_dialog = SelectSubprojectDialog(self.atlas_m.project)
    ...
    def get_project(self, parameters):
        ...
        """
        self.atlas_m.set_project(parameters["project"])
        return self.atlas_m.project
    ...
    def populate_subproject(self, node, active_subproject=""):
        ...
        """
        # return the root
        subproject_obj = self.atlas_m.project.find_sub_by_path(active_subproject)
    ...
    def populate_tasks(self, node, subproject_obj):
        ...
        Args:
            node (hou.Node): The node to populate.
            subproject_obj (atlas_manager.core.subproject.Subproject):
    ...
    def populate_categories(self, node, task_obj=None):
        ...
        Args:
            node (hou.Node): The node to populate.
            task_obj (atlas_manager.core.task.Task): The task object.
        """
        if task_obj:
    ...
    def populate_publishes(self, node, category_obj=None):
        ...
        Args:
            node (hou.Node): The node to populate.
            category_obj (atlas_manager.core.category.Category): The category
                object.
        """
    ...
    def populate_versions(self, node, publish_obj=None):
        ...
        Args:
            node (hou.Node): The node to populate.
            publish_obj (atlas_manager.core.publish.Publish): The publish
                object.
        """
        if publish_obj:
    ...
    def populate_elements(self, node, version_obj=None):
        ...
        Args:
            node (hou.Node): The node to populate.
            version_obj (atlas_manager.core.version.Version): The version
                object.
        """
