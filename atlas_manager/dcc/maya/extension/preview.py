...
from atlas_manager.dcc.extension_core import ExtensionCore
from atlas_manager.ui.dialog.preview_dialog import PreviewDialog
...
class Preview(ExtensionCore):
    ...
    def on_create_preview(self):
        ...
        if not work or not version:
            return
        task = self.atlas.project.find_task_by_id(work.task_id)
