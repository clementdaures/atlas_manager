...
import nuke
from atlas_manager.ui.Qt import QtWidgets, QtCore, QtGui, QtCompat

from atlas_manager.dcc.main_core import MainCore
from atlas_manager.dcc.nuke import utils
from atlas_manager.dcc.nuke import validate
from atlas_manager.dcc.nuke import extract
from atlas_manager.dcc.nuke import ingest
from atlas_manager.dcc.nuke import extension
...
class Dcc(MainCore):
    ...
    def generate_thumbnail(self, file_path, width, height):
        ...
        try:
            ...
            write_node.setName("atlas_tempWrite")
